...
object AlcoholModule : Module {
    ...
    val HOPS by Registration.ITEMS.registerObject("hops") { Item(Registration.Properties) }
    val HOPS_TAG = TagKey.create(Registry.ITEM_REGISTRY, ResourceLocation("forge", "crops/hops"))
    val MASH = Registration.createFluid("mash")
    val DARK_MASH = Registration.createFluid("dark_mash")
    ...
    override fun generateRecipes(builder: RecipeBuilder) {
        ...
        builder.processing(MaturingRecipe.INFO, "wine") {
            ...
            require(JuiceModule.GRAPE_JUICE.getFluid(), MaturingRecipe.DISPLAY_AMOUNT)
            duration(20 * 60 * 10)
        }
